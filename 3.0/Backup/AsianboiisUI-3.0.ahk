...
;Gui, Show, X%GuiX% Y%GuiY% Hide ; bring the gui back to its preferred position on screen
...
/**
 * Sends an advanced backspace key-press. It may simulate the following:
 ...
 * 
 * Params:
 *   string key - the name of the key, or the string to be sent when the ey is pressed.
...
*Z:: Press("`;"	, "'"	, false, false) ; i don't find a way to input double-quote in an ihk script
*X:: Press("q"	, ""	, true)
*C:: Press("j"	, ""	, true)
*V:: Press("k"	, ""	, true)
*B:: Press("x"	, ""	, true)
