...
;{ normal keyboard layout
	...
	#If ((ModsDown & ~ShiftBit = 0) && (!UseSmartSwitch || A_CaretX)) ; no modifier other than shift is held
	{
		...
		*SC029 Up:: ReleaseNormal("3", "``", false, 13, false)
		*1 Up:: ReleaseNormal("4", "1", true, 1, false)
		*2 Up:: ReleaseNormal("7", "2", true, 2, false)
		*3 Up:: ReleaseNormal("8", "3", true, 3, false)
		*4 Up:: ReleaseNormal("=", "4", true, 4, false)
		*5 Up:: ReleaseNormal("[", "5", true, 5, false)
		*6 Up:: ReleaseNormal("]", "6", true, 6, false)
		*7 Up:: ReleaseNormal(",", "7", true, 7, false)
		*8 Up:: ReleaseNormal(".", "8", true, 8, false)
		*9 Up:: ReleaseNormal("9", "9", true, 9, false)
		*0 Up:: ReleaseNormal("0", "0", true, 10, false)
		*- Up:: ReleaseNormal("[", "6", false, 11, false)
		*= Up:: ReleaseNormal("]", "``", false, 12, false)
		*q Up:: ReleaseNormal("'", "'", false, 14, false)
		*w Up:: ReleaseNormal(",", "/", false, 15, false)
		*e Up:: ReleaseNormal(".", "1", false, 16, false)
		*r Up:: ReleaseNormal("p", "p", false, 17, true)
		*t Up:: ReleaseNormal("y", "y", false, 18, true)
		*y Up:: ReleaseNormal("f", "f", false, 19, true)
		*u Up:: ReleaseNormal("g", "g", false, 20, true)
		*i Up:: ReleaseNormal("c", "c", false, 21, true)
		*o Up:: ReleaseNormal("r", "r", false, 22, true)
		*p Up:: ReleaseNormal("l", "l", false, 23, true)
		*[ Up:: ReleaseNormal("/", "5", false, 24, false)
		*] Up:: ReleaseNormal("\", "2", false, 47, false)
		*CapsLock Up:: ReleaseNormal("-", "=", false, 25, false)
		*a Up:: ReleaseNormal("a", "a", false, 26, true)
		*s Up:: ReleaseNormal("o", "o", false, 27, true)
		*d Up:: ReleaseNormal("e", "e", false, 28, true)
		*f Up:: ReleaseNormal("i", "i", false, 29, true)
		*g Up:: ReleaseNormal("u", "u", false, 30, true)
		*h Up:: ReleaseNormal("d", "d", false, 31, true)
		*j Up:: ReleaseNormal("h", "h", false, 32, true)
		*k Up:: ReleaseNormal("t", "t", false, 33, true)
		*l Up:: ReleaseNormal("n", "n", false, 34, true)
		*SC027 Up:: ReleaseNormal("s", "s", false, 35, true)
		*SC028 Up:: ReleaseNormal("-", "\", false, 36, false)
		*z Up:: ReleaseNormal(";", ";", false, 37, false)
		*x Up:: ReleaseNormal("q", "q", false, 38, true)
		*c Up:: ReleaseNormal("j", "j", false, 39, true)
		*v Up:: ReleaseNormal("k", "k", false, 40, true)
		*b Up:: ReleaseNormal("x", "x", false, 41, true)
		*n Up:: ReleaseNormal("b", "b", false, 42, true)
		*m Up:: ReleaseNormal("m", "m", false, 43, true)
		*, Up:: ReleaseNormal("w", "w", false, 44, true)
		*. Up:: ReleaseNormal("v", "v", false, 45, true)
		*SC035 Up:: ReleaseNormal("z", "z", false, 46, true)
	}
	#If
	...
	; isCapShifted: whether the key sent while capslock is down should be logged as a shifted key
	ReleaseNormal(key, shiftedKey, useCapsLock, keyCode, isCapShifted)
	{
		if (IsCapsLockOn ? !(IsCapsLockOn ^ useCapsLock ^ IsShiftDown ^ isCapShifted) : IsShiftDown)
		{
